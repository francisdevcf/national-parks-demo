...
pkg_origin=yourappdemo
pkg_version=7.0.0
pkg_maintainer="Eric Heiser <eheiser@chef.io>"
pkg_license=('Apache-2.0')
pkg_deps=(core/tomcat8 core/corretto/11.0.10.9.1 core/mongo-tools)
pkg_build_deps=(core/corretto/11.0.10.9.1 core/maven)
pkg_svc_user="root"
pkg_binds=(
  [database]="port"
)
...
do_prepare()
{
    export JAVA_HOME=$(hab pkg path core/corretto/11.0.10.9.1)
}
